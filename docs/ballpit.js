/**
 * Ballpit — vanilla JS port (no React, no build step).
 * Original component inspired by Kevin Levron:
 * https://x.com/soju22/status/1858925191671271801
 *
 * Usage:
 *   import { createBallpit } from './ballpit.js';
 *   const instance = createBallpit(canvasEl, { count: 60, colors: [0x16d97a] });
 *   // instance.dispose() to clean up
 */
